...
```bash
https://ghproxy.cc/https://raw.githubusercontent.com/sinkkin/iptvm3u/master/output/iptv.m3u
```

```bash
https://ghproxy.cc/https://raw.githubusercontent.com/sinkkin/iptvm3u/master/output/iptv.txt
```
...
```bash
https://cdn.jsdelivr.net/gh/sinkkin/iptvm3u@master/output/iptv.m3u
```

```bash
https://cdn.jsdelivr.net/gh/sinkkin/iptvm3u@master/output/iptv.txt
```
